...
export const SYSTEM_NODE_PROPERTIES = [
  "node_id",
  "node_label",
  "node_name",
  "relation_comment",
...
export const SYSTEM_NODE_RELATIONS: any[] = [];

export enum KgAPI {
  QueryLabels = "/kg/query-labels",
  QueryProperties = "/kg/query-properties",
  QueryRelations = "kg/query-relations",
  QueryGraph = "kg/query-graph",
  QueryRelatedNodeById = "kg/query-related-node-by-id",
  DeleteNode = "kg/delete-node",
  EditRelation = "kg/edit-relation",
  DeleteEdge = "kg/delete-edge",
  AddNode = "kg/add-node",
  EditNode = "kg/edit-node",
  QueryNodeByIdName = "kg/query-node-by-id-name",
  CreateRelation = "kg/create-relation",
}
